   ...
   <div class="mt-4 mb-4 p-3 bg-white border shadow-sm lh-sm">
       <div class="row border-bottom mb-4">
           ...
           <div class="col-sm-4 text-right pb-3">
               <?php if (isset($siswa) && $siswa != null) : ?>
                   <a class="btn btn-round btn-theme" href="<?= base_url(); ?>datadiri/perbarui/<?= $siswa['id'] ?>">
                       <i class="fa fa-plus"></i> Perbarui Data
                   </a>
               <?php else : ?>
                   <a class="btn btn-round btn-theme" href="<?= base_url(); ?>datadiri/lengkapidata">
                       <i class="fa fa-plus"></i> Lengkapi Data
                   </a>
               <?php endif ?>
           </div>
       </div>
               ...
               <?php else : ?>
                   <div class="text-center py-5">
                       <div class="alert alert-info">
                           <h5 class="mb-2"><i class="fa fa-info-circle"></i> Data Belum Lengkap</h5>
                           <p class="mb-0">Silahkan lengkapi data diri Anda untuk melanjutkan</p>
                       </div>
